...
export default function Header() {
  return (
    <nav className="mx-auto flex w-full justify-between items-center px-4 py-4 sm:px-6">
      ...
      <div className="flex jestify-between items-center gap-10 font-semibold text-md text-zinc-400 px-5 py-5">
